...
def generate_launch_description():
    ...
    # Nodes launching commands - Add 5 second delay for SLAM toolbox
    start_slam_toolbox_cmd = TimerAction(
        period=5.0,
        actions=[
    ...
    # ld.add_action(rsp)  # Commented out - usually started by main robot launch
