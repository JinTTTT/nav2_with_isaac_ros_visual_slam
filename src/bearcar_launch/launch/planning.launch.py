...
def generate_launch_description():
    ...
    pure_pursuit_param_file = os.path.join(
        bearcar_prefix, 'params/pure_pursuit.param.yaml')
    recordreplay_planner_param_file = os.path.join(
        bearcar_prefix, 'params/recordreplay_planner.param.yaml')
    freespace_planner_param_file = os.path.join(
        bearcar_prefix, 'params/freespace_planner.param.yaml')
    ...
    freespace_planner_param = DeclareLaunchArgument(
        ...
        description='Path to config file for freespace planner'
    )
